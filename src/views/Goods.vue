<template>
  <div>
    ...
    <div style="margin: 10px 0">
      <el-input style="width: 300px" placeholder="请输入物品名称查询" suffix-icon="el-icon-search" class="ml-5" v-model="goodsName"></el-input>
      <el-input style="width: 300px" placeholder="请输入物品编号查询" suffix-icon="el-icon-search" class="ml-5" v-model="sn"></el-input>
      <el-input style="width: 300px" placeholder="请输入备注信息查询" suffix-icon="el-icon-search" class="ml-5" v-model="notes"></el-input>
    ...
    <el-table :data="tableData" style="background: #b3e5e5"  @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="sn" label="物品编号">
      </el-table-column>
      <el-table-column prop="name" label="名称">
      </el-table-column>
<!--      <el-table-column prop="specification" label="包装规格">-->
<!--      </el-table-column>-->
      <el-table-column prop="unit" label="单位">
      </el-table-column>
      <el-table-column prop="unitWeight" label="单位重量">
      </el-table-column>
      <el-table-column prop="notes" label="备注描述">
      </el-table-column>
    ...
    <el-dialog title="库位信息" :visible.sync="dialogFormVisible" width="30%">
      <el-form :model="form" label-width="80px" :rules="rules">
        <el-form-item label="物品编号" prop="sn">
...
<!--        </el-form-item>-->
        ...
        <el-form-item label="单位重量">
          <el-input v-model="form.unitWeight" autocomplete="off"></el-input>
        </el-form-item>
